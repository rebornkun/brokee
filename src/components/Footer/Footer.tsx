...
const Footer = () => {
  return (
    <footer className="relative footer flex bg-lightGrey py-[1.5rem]">
      <div className="m-auto container flex flex-col gap-[1rem]">
        <div className="flex justify-center gap-8">
          ...
          <p className="text-[0.9rem] flex gap-4 items-center">
            ...
            <span className="text-grey font-[500]">(55) 345 345 55</span>
          </p>
          <p className="text-[0.9rem] flex gap-4 items-center">
            <MailSvg className="h-[25px] w-[25px]" />
            <span className="text-grey font-[500]">Tradex@uk.co</span>
          </p>
        </div>
