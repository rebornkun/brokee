  ...
  return (
    <section className="flex pb-[8.5rem]">
      <div className="container mx-auto">
        <div className="flex gap-[2rem] bg-white p-[2rem] mt-[-6rem]">
          <Card
        ...
        <div className="w-full flex mt-[6rem] gap-[4rem]">
          <div className="flex flex-col gap-[1.5rem] flex-[1_1_50%]">
            ...
            <div className="flex flex-row w-full justify-between  items-center">
              <h5 className="whitespace-nowrap font-[600] text-[1.3rem] w-[100px]">
                Our Vision
              </h5>
              <div className="bg-lightGrey w-[1px] h-full"></div>
              <p className="text-[1rem] text-grey text-start font-[400] leading-[1.4] w-[320px]">
