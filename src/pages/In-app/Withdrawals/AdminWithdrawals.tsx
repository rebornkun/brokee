...
const AdminWithdrawals = () => {
  ...
  const { isLoading, error, data } = useQuery({
    ...
    queryFn: async (params) => {
      ...
      const res = await getAllWithdrawals(null, {
        sort,
        filter,
        pagination,
        search,
  ...
  const {
    ...
    queryKey: [QueryKeys.GETALLWITHDRAWALSSTATS, userData.id],
    queryFn: async () => {
      const res = await getWithdrawalsStatsForAdmin();
