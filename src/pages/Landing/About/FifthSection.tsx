...
const FifthSection = () => {
  return (
    <section className="flex">
      <div className="container max-md:px-[15px] mx-auto py-[6rem] flex flex-col items-center gap-[1rem]">
        <h1 className="max-md:text-[2rem] text-[2.7rem] font-[600] text-darkGrey">
          Best Pricing & Plan
        </h1>
        <p className="text-center font-[300] text-grey max-md:max-w-full max-w-[70%]">
...
const PriceBox = () => {
  return (
    <div className="px-10 py-8 flex flex-col gap-[0.8rem] flex-[1_1_30%] max-md:max-w-full min-w-[350px] max-w-[30%] rounded-[5px] border-[1px] border-lightGrey">
